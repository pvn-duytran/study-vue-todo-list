...
const styleButton = ref<string>('cursor-pointer p-[10px] rounded-[5px] transition-all hover:bg-gray-200');
...
<template>
  <div class="flex items-center">
    <button
      :class="[styleButton, index == 0 ? 'opacity-30 cursor-not-allowed hover:bg-white' : '']"
      :disabled="index == 0"
    ...
    <button
      :class="[styleButton, index == max - 1 ? 'opacity-30 cursor-not-allowed hover:bg-white' : '']"
